...
function ListSong() {
  ...
  return (
    <div>
      ...
      <br />
      <div>
        <div className='sm:grid hidden grid-cols-[0.5fr_1fr_2fr_1fr_0.5fr] items-center gap-2.5 p-3 border border-gray-300 text-small mr-5 bg-gray-100'>
          <b>image</b>
          <b>name</b>
          <b>album</b>
          <b>duration</b>
